...
* [Multi-Agent Hide and Seek - YouTube](https://www.youtube.com/watch?v=kopoLzvh5jY)
...
* [(Youtube) UNIVESP Profa. Renata Wassermann - Inteligência Artificial - Introdução à Inteligência Artificial - Visão Geral da área](https://www.youtube.com/watch?v=Bcw5YZA-Avw)
* [(Youtube) Dialogos na USP - Inteligencia Artificial (Bloco 1)](https://www.youtube.com/watch?v=7QCepggAQNs)
* [(Youtube) Dialogos na USP - Inteligencia Artificial (Bloco 2)](https://www.youtube.com/watch?v=v9w5dl_b_Wo)
...
* [(Medium) Rational Agents for Artificial Intelligence](https://hackernoon.com/rational-agents-for-artificial-intelligence-caf94af2cec5)
* [(Youtube) DeepMind - The Role of Multi-Agent Learning in Artificial Intelligence Research](https://www.youtube.com/watch?v=yE62Zwhmzi8)

# Resolução de Problemas por meio de Busca

* [(Youtube) UNIVESP Profa. Renata Wassermann - Inteligência Artificial - Resolução de Problemas através de Busca](https://www.youtube.com/watch?v=42uCagWoVeM&list=PLxI8Can9yAHfY4b6dAzpH5_Z-gz4wM-Jq&index=3)
* [(Site Interativo) AIMA Javascript - Solving Problems by Searching](http://aimacode.github.io/aima-javascript/3-Solving-Problems-By-Searching/)
* [(Site) Ray Toal - Notes on Problem Solving](https://cs.lmu.edu/~ray/notes/problemsolving/)
* [(Youtube) Floor Coverage Lab Test | Roomba® | iRobot®](https://www.youtube.com/watch?v=7FSUtSurqA4) 
...
* [(Site) Breadth-First Search Part 1 - Coding Challenge #68.1 · The Coding Train](https://thecodingtrain.com/CodingChallenges/068.1-bfs-kevin-bacon.html)
* [(Site) Breadth-First Search Part 2 - Coding Challenge #68.2 · The Coding Train](https://thecodingtrain.com/CodingChallenges/068.2-bfs-kevin-bacon.html)
* [(Youtube) MIT OpenCourseWare - 13. Breadth-First Search (BFS)](https://www.youtube.com/watch?v=s-CYnVz-uh4)

### Busca em Profundidade

* [(Site) MIT OpenCourseWare Lecture 14: Depth-First Search (DFS), Topological Sort](https://ocw.mit.edu/courses/electrical-engineering-and-computer-science/6-006-introduction-to-algorithms-fall-2011/lecture-videos/lecture-14-depth-first-search-dfs-topological-sort/)
...
* [(Site) Coding Train - A* Pathfinding Algorithm - Part 1](https://thecodingtrain.com/CodingChallenges/051.1-astar.html)
* [(Site) Coding Train - A* Pathfinding Algorithm - Part 2](https://thecodingtrain.com/CodingChallenges/051.2-astar.html)
* [(Site) Coding Train - A* Pathfinding Algorithm - Part 3](https://thecodingtrain.com/CodingChallenges/051.3-astar.html)
